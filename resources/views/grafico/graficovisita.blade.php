<!-- resources/views/grafico-visitas.blade.php -->
...
@section('content')
    ...
    <script>
        ...
        var cantidadVisitas = @json($cantidadVisitas);
        ...
        var myBarChart = new Chart(ctxBar, {
            ...
            data: {
                labels: paginas,
                datasets: [{
                    label: 'Visitas por página (Gráfico de barras)',
        ...
        var myPieChart = new Chart(ctxPie, {
            ...
            data: {
                labels: paginas,
                datasets: [{
                    label: 'Visitas por página (Gráfico de pastel)',
                    data: cantidadVisitas,
                    backgroundColor: [
                        'rgba(255, 99, 132, 0.2)',
                        'rgba(54, 162, 235, 0.2)',
        ...
        var myCustomChart = new Chart(ctxCustom, {
            ...
            data: {
                labels: paginas,
                datasets: [{
                    label: 'Visitas por página (Gráfico personalizado)',
                    data: cantidadVisitas,
                    fill: false,
                    borderColor: 'rgba(75, 192, 192, 1)',
                    borderWidth: 2
        ...
        var myGroupedBarChart = new Chart(ctxGroupedBar, {
            ...
            data: {
                labels: paginas,
                datasets: [{
                    label: 'Visitas por página (Gráfico de barras agrupadas)',
                    data: cantidadVisitas,
