        ...
        <nav id="sidebar" class="active">
            ...
            <div class="p-4">
                ...
                <ul class="list-unstyled components mb-5">
                    <li class="active">
                        <a href="rol"><span class="fa fa-home mr-3"></span> Rol</a>
                    </li>
                    <li>
                        <a href="sucursal"><span class="fa fa-user mr-3"></span> Sucursales</a>
                    </li>
                    <li>
                        <a href="user"><span class="fa fa-briefcase mr-3"></span> Usuarios</a>
                    </li>
