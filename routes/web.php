...
Route::get('/user/{user_id}', [HorarioUserController::class, 'showUserHorarios'])
    ->name('showUserHorarios')
    ->middleware(['auth']);

Route::get('/sucursal/{sucursal_id}/', [SucursalController::class, 'trabajadoresPorSucursal'])
